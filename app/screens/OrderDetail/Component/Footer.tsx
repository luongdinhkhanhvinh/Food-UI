...
const Footer = memo((props: PropsFooter) => {
    ...
    return (
        <>
            <RowSelection nameTitle={"Box Size"} nameValue={boxSize} noChange={false} />
            <RowSelection nameTitle={"Delivery Date"} nameValue={deliveryDate} noChange={false} />
            ...
            <RowAddress
                ...
                noChange={false}
            />
            <RowSelection nameTitle={"Delivery Instruction"} nameValue={instruction} noChange={false} />
